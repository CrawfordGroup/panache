...
#include "Math.h"
#include "Exception.h"
#include "ObaraSaikaTwoCenterRecursion.h"
#include "libciomr.h"
...
{
    if (max_am1 < 0)
        throw RuntimeError("ObaraSaikaTwoCenterMIRecursion -- max_am1 must be nonnegative");
    if (max_am2 < 0)
        throw RuntimeError("ERROR: ObaraSaikaTwoCenterMIRecursion -- max_am2 must be nonnegative");
//    if (max_m > 3)
//        throw RuntimeError("ERROR: ObaraSaikaTwoCenterMIRecursion -- max_m must be nonnegative and less than 4");
...
void ObaraSaikaTwoCenterMIRecursion::compute(double PA[3], double PB[3], double gamma, int am1, int am2)
{
    if (am1 < 0 || am1 > max_am1_)
        throw RuntimeError("ERROR: ObaraSaikaTwoCenterMIRecursion::compute -- am1 out of bounds");
    if (am2 < 0 || am2 > max_am2_)
        throw RuntimeError("ERROR: ObaraSaikaTwoCenterMIRecursion::compute -- am2 out of bounds");
...
{
    if (max_am1 < 0)
        throw RuntimeError("ERROR: ObaraSaikaTwoCenterMVIRecursion -- max_am1 must be nonnegative");
    if (max_am2 < 0)
        throw RuntimeError("ERROR: ObaraSaikaTwoCenterMVIRecursion -- max_am2 must be nonnegative");
...
void ObaraSaikaTwoCenterEFPRecursion::calculate_f(double *F, int n, double t)
{
    ...
    if (t>20.0){
        ...
        t2 = 2*t;
        m2 = 2*n;
        num = Math::double_factorial_nminus1(m2);
        i=0;
        sum = 1.0/(m2+1);
        do{
            i++;
            num = num*t2;
            term1 = num/Math::double_factorial_nminus1(m2+2*i+2);
            sum += term1;
        } while (fabs(term1) > EPS);
        F[n] = sum*et;
        for(m=n-1;m>=0;m--){
...
{
    if (max_am1 < 0)
        throw RuntimeError("ERROR: ObaraSaikaTwoCenterRecursion -- max_am1 must be nonnegative");
    if (max_am2 < 0)
        throw RuntimeError("ERROR: ObaraSaikaTwoCenterRecursion -- max_am2 must be nonnegative");
...
{
    if (am1 < 0 || am1 > max_am1_)
        throw RuntimeError("ERROR: ObaraSaikaTwoCenterRecursion::compute -- am1 out of bounds");
    if (am2 < 0 || am2 > max_am2_)
        throw RuntimeError("ERROR: ObaraSaikaTwoCenterRecursion::compute -- am2 out of bounds");
...
{
    if (max_am1 < 0)
        throw RuntimeError("ERROR: ObaraSaikaTwoCenterVIRecursion -- max_am1 must be nonnegative");
    if (max_am2 < 0)
        throw RuntimeError("ERROR: ObaraSaikaTwoCenterVIRecursion -- max_am2 must be nonnegative");
...
{
    if (max_am1 < 0)
        throw RuntimeError("ERROR: ObaraSaikaThreeCenterRecursion -- max_am1 must be nonnegative");
    if (max_am2 < 0)
        throw RuntimeError("ERROR: ObaraSaikaThreeCenterRecursion -- max_am2 must be nonnegative");
    if (max_am3 < 0)
        throw RuntimeError("ERROR: ObaraSaikaThreeCenterRecursion -- max_am3 must be nonnegative");
...
void ObaraSaikaThreeCenterRecursion::compute(double GA[3], double GB[3], double GC[3], double gamma, int amA, int amB, int amC)
{
    if (amA < 0 || amA > max_am1_)
        throw RuntimeError("ERROR: ObaraSaikaThreeCenterRecursion::compute -- am1 out of bounds");
    if (amB < 0 || amB > max_am2_)
        throw RuntimeError("ERROR: ObaraSaikaThreeCenterRecursion::compute -- am2 out of bounds");
    if (amC < 0 || amC > max_am3_)
        throw RuntimeError("ERROR: ObaraSaikaThreeCenterRecursion::compute -- am3 out of bounds");
